...
public class Lang {
    ...
    public Component safeSellConfirm = Component.text("Are you sure you want to sell this property? You won't get the items in the stash back. You will keep the the amount the property cost and what was in the safe. If you are sure, please type /safe sell yes", TextColor.color(210, 100, 37)));
    public Component propSellMessage = Component.text("Property sold.", TextColor.color(210, 100, 37)));
